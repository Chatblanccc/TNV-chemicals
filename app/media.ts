...
export const media = {
  ...
  applicationPackaging: placeholder("application-packaging", "/images/application-packaging.webp", "Cyan ink transferring through an industrial printing roller system", 1448, 1086, "55% 50%", "Flexible packaging application card", "Replace with original TNV-compatible press photography, minimum 1400 × 1050 px."),
  applicationPaper: placeholder("application-paper", "/images/application-paper.webp", "Stacked uncoated paper sheets with visible natural edges", 1448, 1086, "50% 48%", "Paper and corrugated application card", "Replace with original samples from a verified TNV paper application, minimum 1400 × 1050 px."),
  applicationSpecialty: placeholder("application-specialty", "/images/application-specialty-print.webp", "Macro view of cyan halftone dots on a specialty print substrate", 1448, 1086, "52% 48%", "Labels and specialty print application card", "Replace with original TNV print-result photography, minimum 1400 × 1050 px."),
  ...
  evidenceRnd: placeholder("evidence-rnd", "/images/evidence-rnd.webp", "Gloved technician evaluating a cyan ink sample in a clean laboratory", 1448, 1086, "50% 48%", "Research and development evidence", "Replace with an original TNV laboratory workflow photograph after safety and privacy review."),
  evidenceFactory: placeholder("evidence-factory", "/images/evidence-factory.webp", "Clean industrial mixing and process equipment", 1448, 1086, "50% 50%", "Manufacturing evidence", "Replace with an original TNV facility photograph after equipment and capacity claims are verified."),
  evidenceQc: placeholder("evidence-qc", "/images/evidence-quality-control.webp", "Laboratory technician checking a material sample", 1448, 1086, "58% 46%", "Quality-control evidence", "Replace with an original TNV quality-control photograph after the depicted procedure is verified."),
} as const;
